function getPhoto()
{
  var apigClient = apigClientFactory.newClient({
                     apiKey: "88NQTcdknS5YEKEUKclr17Fe9OBL9VBUamoQOUEY"
        });
    ...
    apigClient.searchGet(params, body , additionalParams).then(function(result){
        ...
        rdata.forEach( function(obj) {
            var img = new Image();
            img.src = "https://bucketphotos2.s3.amazonaws.com/"+obj;
...
function submitPhoto()
{
   ...
   var base64_image = convertImgBase64(img_file).then(
     ...
     var params = {"key" : img_file.name, "bucket" : "bucketphotos2", "Content-Type" : img_file.type + ";base64", "x-amz-meta-CustomLabels": mlabels};
